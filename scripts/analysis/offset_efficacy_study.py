...
def _split_terms(result: dict, validation: bool) -> np.ndarray:
    ...
    def one(reference, robot_key, estimator_key, start_offsets):
        return closed_loop_objective_terms(
            ...
            robot_key,
            estimator_key,
            linear_velocity_tracking_weight=GAIN_TUNING_DEFAULTS["linear_velocity_tracking_weight"],
            angular_velocity_tracking_weight=GAIN_TUNING_DEFAULTS["angular_velocity_tracking_weight"],
