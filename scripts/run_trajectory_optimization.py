...
def main():
    ...
    print(f"Closed-loop pose samples: {len(pipeline.closed_loop_log.poses)} at dt={pipeline.problem.wheel_dt}")
    print(f"Start pose: {pipeline.reference_states[0, :3]}")
    print(f"Goal pose:  {pipeline.reference_states[-1, :3]}")
