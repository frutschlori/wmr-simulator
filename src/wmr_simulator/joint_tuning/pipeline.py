...
def run_joint_tuning(
    ...
    *,
    ...
    linear_velocity_tracking_weight: float = float(GAIN_TUNING_DEFAULTS["linear_velocity_tracking_weight"]),
    angular_velocity_tracking_weight: float = float(GAIN_TUNING_DEFAULTS["angular_velocity_tracking_weight"]),
