...
def plot_joint_tuning_trajectories(result, out_prefix: str = "joint_tuning_trajectories", out_path=None):
    ...
    return plot_trajectory_set(
        result.reference_states,
        closed_loop_poses,
        control_point_batch=result.control_points,
        out_prefix=out_prefix,
        out_path=out_path,
        title="Jointly Optimized Trajectories",
    )
